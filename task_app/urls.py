...
urlpatterns = [
    ...
    path('assigned_to_me/archive/', views.archived_assigned_to_me, name='archived_assigned_to_me'),
    path('assigned_by_me/', views.assigned_by_me, name='assigned_by_me'),  # Tickets assigned by the user
    path('assigned_by_me/archive/', views.archived_assigned_by_me, name='archived_assigned_by_me'),
    path('mode/<str:mode>/', views.set_ticket_mode, name='set_ticket_mode'),
    path('logout/', views.support_logout, name='support_logout'),
